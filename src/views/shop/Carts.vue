            ...
            <v-stepper-items>
                      ...
                      <v-col cols="6">
                        <v-row>
                          <v-col cols="6" class="text-right text-subtitle-2"
                            >總計金額</v-col
                          >
                          <v-col cols="6" class="text-right text-subtitle-2">$ 10000</v-col>
                          <v-col cols="6" class="text-right text-subtitle-2"
                            >優惠折抵</v-col
                          >
                          <v-col cols="6" class="text-right text-subtitle-2">-$ 10999</v-col>
                          <v-col cols="6" class="text-right text-subtitle-1 blue-grey--text"
                            >應付金額</v-col
                          >
                          <v-col cols="6" class="text-right text-subtitle-1 blue-grey--text">$ 100000</v-col>
                        </v-row>
                      </v-col>
                    </v-row>
                    <v-divider></v-divider>
              ...
              <v-stepper-content step="2">
                <v-card color="grey lighten-1" class="mb-12" height="200px"
                  >22222</v-card
                >
                <v-btn color="primary" @click="stepEl = 3">
                  Continue
                </v-btn>
                <v-btn text>
                  Cancel
